...
- **Smart Fertigation** — controlled-release nutrients, precision fertigation, soil/EC/pH sensors, and AI decision support at the root zone.
...
└── assets/
    ...
    ├── smart-fertigation.png  # Smart Fertigation section visual
    └── img/
        ├── favicon.svg
...
- [ ] Replace `hello@aquaclimatelab.com` in `index.html` with the real contact email.
